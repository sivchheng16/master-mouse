...
export const ShapePuzzle: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      <div className="absolute top-6 left-1/2 -translate-x-1/2 text-center w-full z-10">
        <h2 className="title-font text-2xl md:text-3xl text-slate-800">ដាក់រូបរាងឱ្យត្រូវកន្លែង!</h2>
        <p className="text-slate-400 font-bold uppercase text-xs tracking-widest mt-1">Drag and drop the shapes</p>
      </div>
