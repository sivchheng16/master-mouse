...
export const BobaShake: React.FC<{
  onComplete: () => void;
  count?: number;
}> = ({ onComplete, count = 3 }) => {
  ...
  return (
    ...
    >
      <GameHUD
        ...
        instruction={languageService.t("game.boba_shake_instruction")}
      ...
      {/* Boba tea cup */}
      <div
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${shakeProgress > 0 && !completed ? "animate-shake" : ""}`}
      >
        {/* Cup body */}
        <div className="relative w-32 h-48 md:w-40 md:h-56">
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 10px 40px rgba(0,0,0,0.1), inset 0 0 30px rgba(255,255,255,0.5)",
            }}
          >
            {/* Tea liquid */}
            <div
