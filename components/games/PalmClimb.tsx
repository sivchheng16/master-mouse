    ...
    return (
        ...
        >
            ...
            <GameHUD
                ...
                instruction="រមូរកងរំកិលដើម្បីឡើង! 🥥"
                score={collected}
                goal={numFruits}
            />
            ...
            <div
                className="absolute w-[380px] h-[380px] pointer-events-none z-19 flex justify-center items-center"
                style={{
            ...
            >
                ...
                <div className="relative w-full h-full animate-sway-slow origin-center">
                    <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-[#2d4a22] rounded-full z-10 -translate-x-1/2 -translate-y-1/1" />
            ...
            <div
                className="absolute w-[380px] h-[380px] pointer-events-none z-21 flex justify-center items-center"
                style={{
                    left: `${getTrunkX(TREE_TOP_Y)}%`,
                    top: `${TREE_TOP_Y - 19}%`,
                    transform: 'translateX(-50%)'
            ...
            {particles.map(p => (
                <div
                    key={p.id}
                    className="absolute z-10 pointer-events-none text-2xl"
                    style={{
                        left: `${p.x}%`,
                        top: `${p.y}%`,
                        transform: `translate(-50%, -50%)`,
