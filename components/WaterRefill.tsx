  ...
  return (
    ...
    >
      <div className="absolute top-10 text-center z-20">
        <h2 className="title-font text-3xl md:text-4xl text-blue-900 mb-4 drop-shadow-sm">ចុចឱ្យជាប់ដើម្បីបំពេញទឹក!</h2>
        <div className={`mx-auto px-8 py-3 rounded-2xl font-black text-lg uppercase transition-all shadow-lg border-2 ${
          isComplete 
          ...
          {isComplete ? 'ពេញហើយ! ✨' : isHolding ? 'កំពុងបំពេញ...' : 'ចុចម៉ៅឱ្យជាប់'}
        </div>
      </div>
