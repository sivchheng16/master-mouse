        ...
        >
            ...
            <div className="absolute top-4 left-0 right-0 z-10">
                <GameHUD
                    ...
                    instruction="ទិញបន្លែផ្លែឈើដាក់កន្រ្តក! 🧺"
                    score={collected}
                    goal={currentCount}
                />
            </div>
            ...
            <div className="absolute inset-0 pt-[180px] top-0 bottom-0 flex z-10 p-6 gap-20">
                ...
                <div className="w-[320px] flex flex-col gap-4 h-full relative z-20 pointer-events-none">
                    ...
                    <div className="flex-1 bg-yellow-50 rounded-xl shadow-xl border border-gray-200 relative overflow-hidden transform -rotate-1">
                        {/* Top binding */}
